...
import { Button, Container, Card, Form, InputGroup, Navbar, Nav, Modal, Spinner, Table, Badge, Alert } from "react-bootstrap";
...
const Login = () => {
  ...
  return (
    <Layout>
      ...
      <Container className="vh-100 w-100" style={{ backgroundColor: "grey" }}>
